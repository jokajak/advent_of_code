#!/usr/bin/env python
"""Solutions for AoC 23, 2022."""
# Created: 2022-12-23 10:48:23.287459
...
from aoc.utils.pathfinding import GridLocation, SquareGrid
...
class Elf(SquareGrid):
    ...
    def get_next_step(self, id: GridLocation) -> Iterator[GridLocation]:
...
def solve_part_one(input_data):
    ...
    *somewhere*."
    ...
    not have the patience to calculate *arbitrary rectangles*.) In the
    above example, that rectangle is:
    ```
    ......#.....
    ..........#.
    .#.#..#.....
...
def main():
    ...
    u = default_user()
    stats = u.get_stats(2022).get((2022, 23), {})
